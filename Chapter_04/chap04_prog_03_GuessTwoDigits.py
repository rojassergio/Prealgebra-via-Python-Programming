...
thenumber = myfuncReadInt() # improve the program by reading a random number
if thenumber == None:
   ...
   if len(temp) == 3:
       ...
       reversenum = ''
       for i in temp:
           reversenum = i + reversenum
       reversenum = int(reversenum)
       print('Step 3.- Computing the difference of the two numbers')
       if thenumber > reversenum:
          difference = thenumber - reversenum
       else:
          difference = reversenum - thenumber
